  ...
  return (
    <div className="work-exp">
      ...
      <div className="darkColor text-bold d-flex">
        <div style={{ marginLeft: "2%", fontSize: "large" }}>SurveyAuto</div>
      ...
      <div>
        <ul className="darkColor" style={{ marginLeft: "2%" }}>
          ...
          <li>
            Develop web applications for visiualizing data using different APIs
            of google maps and different type of charts.{" "}
          </li>
          <li>
            Frontend Development ( ReactJs,TypeScript,Redux,ES6,Firebase,Google
            Map APIs).
          </li>
          <li>
