...
const MainHeading = () => {
	return (
		<>
			<Col className="mb-4  d-flex mainHeader-content-name align-items-center" xl="6" lg="6" md="6" sm="6">
				<span className="mainHeader-content-name align-items-center">
					<h1 className="muhammad-ahmad">Muhammad Ahmad</h1>
					<h4 className="soft-eng">Software Engineer</h4>
				</span>
			</Col>
			<Col className="mb-4 d-flex mainHeader-content-img align-items-center" xl="6" lg="6" md="6" sm="6">
				<span>
					<img
						src={ahmadImage}
						alt="ahmad_image"
